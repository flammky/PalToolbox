...
@Composable
fun rememberPlayerInventoryEquipArmorSlotEditState(
    inventoryState: InventoryEditPanelState
): PlayerInventoryEquipArmorSlotEditState {

    val state = remember(inventoryState) {
        PlayerInventoryEquipArmorSlotEditState(inventoryState)
    }
...
@Stable
class PlayerInventoryEquipArmorSlotEditState(
    ...
    private fun init() {
        coroutineScope.launch {
            ...
            val entries = editor.getOrParseInventoryEntryAsync("PlayerEquipArmorContainerId").await()
